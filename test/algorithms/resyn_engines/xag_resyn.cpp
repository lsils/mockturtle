...
TEST_CASE( "Depth Optimization", "[costfn_resyn]" )
{
  ...
  kitty::create_from_binary_string( tts[0], "11111100" );
  kitty::create_from_binary_string( tts[1], "11110011" );
  ...
  xag_resyn_decompose<TT, xag_resyn_static_params_preserve_depth<TT>> engine( st );

  std::function<uint32_t(uint32_t)> const size_cost_fn  = [&]( uint32_t idx ){ return 0u; };
  std::function<uint32_t(uint32_t)> const depth_cost_fn = [&]( uint32_t idx ){ return 2u; };

  const auto res = engine( target, care, divs.begin(), divs.end(), tts, size_cost_fn, depth_cost_fn, 3, 6 );

  CHECK( res );
  CHECK( (*res).num_gates() == 1 );
  xag_network xag;
  decode( xag, *res );

  const auto ans = simulate<TT, xag_network, partial_simulator>( xag, sim )[0];
...
TEST_CASE( "Depth Optimization with negation", "[costfn_resyn]" )
{
  ...
  kitty::create_from_binary_string( target, "11110000" ); // target
  kitty::create_from_binary_string( tts[0], "00000011" );
  kitty::create_from_binary_string( tts[1], "11110011" );
  kitty::create_from_binary_string( tts[2], "01011111" ); // binate
...
TEST_CASE( "Depth Optimization with OR-AND", "[costfn_resyn]" )
{
  ...
  kitty::create_from_binary_string( target, "11110000" ); // target
  kitty::create_from_binary_string( tts[0], "10000000" );
  kitty::create_from_binary_string( tts[1], "11111000" );
  kitty::create_from_binary_string( tts[2], "01110111" );
...
TEST_CASE( "Depth Optimization with OR-OR", "[costfn_resyn]" )
{
  ...
  kitty::create_from_binary_string( target, "11110000" ); // target
  kitty::create_from_binary_string( tts[0], "10000000" );
  kitty::create_from_binary_string( tts[1], "01000000" );
...
TEST_CASE( "Depth Optimization with XOR-XOR", "[costfn_resyn_xor]" )
{
  ...
  kitty::create_from_binary_string( target, "11110000" ); // target
  kitty::create_from_binary_string( tts[0], "11010110" );
  kitty::create_from_binary_string( tts[1], "01011011" );
  kitty::create_from_binary_string( tts[2], "01111101" );
