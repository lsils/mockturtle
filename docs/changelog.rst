...
* Network implementations:
    ...
    - Cover network (`cover_network`) _#512 <https://github.com/lsils/mockturtle/pull/512>`_
* Algorithms:
    ...
    - Conversion of a cover network into a graph (`cover_to_graph`) _#512 <https://github.com/lsils/mockturtle/pull/512>`_
* Views:
