...
int main()
{
  ...
  for ( auto const& benchmark : epfl_benchmarks() )
  {
    ...
    auto _c1 = cost_view( xag, costfn1 ).get_cost();
    auto _c2 = cost_view( xag, costfn2 ).get_cost();
    auto _c3 = cost_view( xag, costfn3 ).get_cost();
    auto _c4 = cost_view( xag, costfn4 ).get_cost();
    auto _c5 = cost_view( xag, costfn5 ).get_cost();
